...
<div class="lg:flex  lg:w-3/4 lg:items-center lg:justify-between">
  ...
  <div class="mt-5 flex lg:mt-0 lg:ml-4">
    ...
    <span class="sm:ml-3">
           <button type="button" @click="$inertia.visit(route('vehicules.index'))" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 ">
...
export default {
  ...
  methods:{
      submit() {
      this.form.post(this.route('vehicules.store'), {
